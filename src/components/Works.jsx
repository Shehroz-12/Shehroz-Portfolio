  ...
  return (
    <div ref={cardRef}>
      <Tilt
        ...
        className="bg-tertiary p-5 rounded-2xl w-full h-full flex flex-col min-h-[500px]"
      >
        {/* image */}
...
const Works = () => {
  ...
  return (
    <>
      ...
      <div className="works-container mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 items-stretch">
